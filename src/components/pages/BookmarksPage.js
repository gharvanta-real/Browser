...
export class BookmarksPage extends BaseComponent {
            ...
            <div class="aero-bookmarks-page">
                ...
                <div class="bookmarks-main-content">
                    <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                        <div style="display: flex; align-items: center; gap: var(--spacing-sm);">
                            <button id="bookmarks-back-btn" class="page-back-btn" style="background: transparent; border: none; outline: none; cursor: pointer; color: var(--color-text-inactive); display: flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 50%; transition: background var(--transition-fast);">
    ...
    afterRender() {
        this.querySelector('#bookmarks-back-btn')?.addEventListener('click', () => {
            this.navigateBack();
        });
